...
def seed_data():
    ...
    # We force ID=1 because your controller has 'client_id = 1' hardcoded
    ...
    # --- 2. Create Active Projects (Matching Figma) ---
    p1 = Project(
        client_id=1,
    ...
    # --- 3. Create Contracts (To calculate Total Spent) ---
    # Total spent needs to be around $48,920 to match Figma
