...
const FreelancerProfile = () => {
  const skills = ['React', 'Node.js', 'TypeScript', 'JavaScript', 'Python', 'MongoDB', 'PostgreSQL', 'AWS', 'Docker', 'Git', 'REST APIs', 'GraphQL'];
      ...
      <div style={{ display: 'flex', gap: '30px' }}>
        ...
        <div style={{ width: '300px' }}>
          <div style={{ backgroundColor: 'white', padding: '30px', borderRadius: '15px', textAlign: 'center', border: '1px solid #E9ECEF', marginBottom: '20px' }}>
            ...
            <button style={{ width: '100%', padding: '10px', backgroundColor: '#FF7A1A', color: 'white', border: 'none', borderRadius: '8px', fontWeight: 'bold' }}>Edit Profile</button>
          </div>
        ...
        <div style={{ flex: 1 }}>
          ...
          <section style={{ backgroundColor: 'white', padding: '25px', borderRadius: '15px', border: '1px solid #E9ECEF' }}>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <p style={{ color: '#6C757D', fontSize: '14px' }}>Leading development of enterprise web applications using React and Node.js.</p>
            </div>
          </section>
        </div>
      </div>
