    ...
    <div style={{ minHeight:"100vh", background:"linear-gradient(135deg,#0a0520 0%,#0f0c29 30%,#1a0845 60%,#0d1b3e 100%)", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"'Segoe UI',sans-serif", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ ...fadeUp, position:"relative", zIndex:10, backgroundColor:"#ffffff", borderRadius:24, padding:"44px 40px", width:"100%", maxWidth:440, boxShadow:"0 20px 60px rgba(0,0,0,0.4)", border:"1px solid rgba(255,255,255,0.2)" }}>
        ...
        <div style={{ textAlign:"center", marginBottom:28 }}>
          ...
          <h2 style={{ fontSize:24, fontWeight:800, color:"#111827", marginBottom:8, letterSpacing:"-0.5px" }}>Reset Password</h2>
          <p style={{ fontSize:14, color:"#6b7280" }}>Enter your new password below.</p>
        </div>
        ...
        <input className="inp-focus" type="password" placeholder="Min. 6 characters" value={password} onChange={e => setPassword(e.target.value)}
          style={{ width:"100%", padding:"12px 16px", border:"1.5px solid #e5e7eb", borderRadius:10, fontSize:14, backgroundColor:"#f9fafb", outline:"none", boxSizing:"border-box", marginBottom:8, transition:"all 0.2s", color:"#111827" }} />
        ...
        <input className="inp-focus" type="password" placeholder="Confirm new password" value={confirm} onChange={e => setConfirm(e.target.value)} onKeyDown={e => e.key === "Enter" && handleSubmit()}
          style={{ width:"100%", padding:"12px 16px", border:`1.5px solid ${confirm && confirm !== password ? "#ef4444" : "#e5e7eb"}`, borderRadius:10, fontSize:14, backgroundColor:"#f9fafb", outline:"none", boxSizing:"border-box", marginBottom: confirm && confirm !== password ? 4 : 24, transition:"all 0.2s", color:"#111827" }} />
