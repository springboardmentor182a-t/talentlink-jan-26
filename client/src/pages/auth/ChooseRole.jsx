...
export default function ChooseRole() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"linear-gradient(135deg,#0a0520 0%,#0f0c29 30%,#1a0845 60%,#0d1b3e 100%)", fontFamily:"'Segoe UI',sans-serif", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ position:"fixed", top:50, right:-100, width:400, height:400, borderRadius:"50%", background:"radial-gradient(circle, rgba(59,130,246,0.5) 0%, rgba(59,130,246,0.15) 40%, transparent 70%)", pointerEvents:"none", animation:"pulse 6s ease-in-out infinite 1s", filter:"blur(25px)", zIndex:0 }} />
      <div style={{ position:"fixed", top:"35%", left:-80, width:350, height:350, borderRadius:"50%", background:"radial-gradient(circle, rgba(168,85,247,0.5) 0%, rgba(168,85,247,0.15) 40%, transparent 70%)", pointerEvents:"none", animation:"pulse 5s ease-in-out infinite 2s", filter:"blur(25px)", zIndex:0 }} />
      <div style={{ position:"fixed", top:"20%", right:"20%", width:300, height:300, borderRadius:"50%", background:"radial-gradient(circle, rgba(99,102,241,0.4) 0%, rgba(99,102,241,0.1) 40%, transparent 70%)", pointerEvents:"none", animation:"pulse 7s ease-in-out infinite 0.5s", filter:"blur(20px)", zIndex:0 }} />
      <div style={{ position:"fixed", bottom:"20%", left:"20%", width:280, height:280, borderRadius:"50%", background:"radial-gradient(circle, rgba(139,92,246,0.4) 0%, rgba(139,92,246,0.1) 40%, transparent 70%)", pointerEvents:"none", animation:"pulse 8s ease-in-out infinite 1.5s", filter:"blur(20px)", zIndex:0 }} />
      ...
      <div style={{ position:"relative", zIndex:10, display:"flex", justifyContent:"space-between", alignItems:"center", padding:"18px 40px", backgroundColor:"rgba(255,255,255,0.05)", borderBottom:"1px solid rgba(255,255,255,0.1)", backdropFilter:"blur(20px)" }}>
        ...
        <div style={{ fontSize:13, color:"rgba(255,255,255,0.6)" }}>
          ...
          <span onClick={() => navigate("/client/login")} style={{ color:"#60a5fa", fontWeight:600, cursor:"pointer" }}>Sign in</span>
        </div>
      </div>
  ...
  <span style={{ background:"linear-gradient(135deg,#a78bfa,#f472b6,#fb7185)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>
    Collaborate,
  </span>{" "}
  <span style={{ background:"linear-gradient(135deg,#f472b6,#fb7185,#60a5fa)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>
    Create
  </span>
</h1>
      ...
      <div style={{ ...fadeInDelay2, position:"relative", zIndex:10, display:"flex", justifyContent:"center", gap:28, padding:"0 40px 60px", flexWrap:"wrap" }}>
        ...
        {/* Client Card */}
        <div style={cardStyle(hoverClient)}
        ...
        {/* Freelancer Card */}
        <div style={cardStyle(hoverFreelancer)}
          onMouseEnter={() => setHoverFreelancer(true)}
          onMouseLeave={() => setHoverFreelancer(false)}>
